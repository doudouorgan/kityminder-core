...
_p[0] = {
    value: function(require, exports, module) {
        ...
        connect.register("arc", function(node, parent, connection, width, color) {
            ...
            end = side === "left" ? new kity.Point(box.right + node.getStyle("main-connect-margin") || 2, box.cy) : new kity.Point(box.left - node.getStyle("main-connect-margin") || 2, box.cy);
...
_p[1] = {
    value: function(require, exports, module) {
        ...
        connect.register("arc_branch", function(node, parent, connection, width, color) {
            ...
            var side = box.x > pBox.x ? "right" : "left";
            node.getMinder().getPaper().addResource(connectMarker);
            var start1 = new kity.Point(pBox.cx - offsetWidth, pBox.cy), start2 = new kity.Point(pBox.cx + offsetWidth, pBox.cy);
            end = side === "left" ? new kity.Point(box.right + node.getStyle("main-connect-margin") || 2, box.cy) : new kity.Point(box.left - node.getStyle("main-connect-margin") || 2, box.cy);
...
_p[4] = {
    value: function(require, exports, module) {
        ...
        connect.register("bezier_branch", function(node, parent, connection) {
            ...
            var abs = Math.abs;
            var pathData = [];
            var startPoint = new kity.Point(r(po.x - 30), r(po.y - 20)), startOffsetPoint = new kity.Point(r(po.x - 30), r(po.y + 20));
    ...
    value: function(require, exports, module) {
        ...
        var Minder = kity.createClass("Minder", {
            constructor: function(options) {
                ...
                this.colorPool = [ "#FAC6D2", "#F384AE", "#F15A23", "#C41230", "#7DCDC2", "#55BEED", "#31A8E0", "#0076B3", "#B296C7", "#662C90", "#C1D18A", "#80BC42", "#00A650", "#16884A", "#E9D4A7", "#FDB813", "#F68B1F", "#F1753F", "#9F8759", "#924517", "#CFD0D2", "#98A2AB", "#8A8B8F", "#381E11" ];
...
_p[23] = {
     ...
     */
         ...
         * 获取节点的主节点
         */
            getMain: function(node) {
                if (node.getType() === "main") {
                    return node;
                } else if (node.getParent().getType() === "main") {
                    return node.getParent();
                } else {
                    return this.getMain(node.getParent());
                }
            },
            /**
         * 获得节点的父节点
...
_p[58] = {
    value: function(require, exports, module) {
        ...
        Module.register("PriorityModule", function() {
            ...
            [ "#dd700b", "#f29036" ], // 2 - blue
            [ "#22a384", "#3abc9d" ], // 3 - green
            [ "#0184dd", "#0299ff" ], // 4 - orange
            [ "#6158a8", "#7d75bf" ], // 5 - purple
            [ "#2b859d", "#419fc2" ], // 6,7,8,9 - gray
            [ "#2b859d", "#515151" ], [ "#4d6384", "#647da4" ], [ "#6d6a96", "#535177" ] ];
            // hue from 1 to 5
            // jscs:disable maximumLineLength
