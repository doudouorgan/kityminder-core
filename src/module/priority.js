    ...
    Module.register('PriorityModule', function () {
        ...
        var PriorityIcon = kity.createClass('PriorityIcon', {
            ...
            create: function () {
                ...
                number = new kity.Text().setX(this.width / 2 - 0.5).setY(this.height / 2).setTextAnchor('middle').setVerticalAlign('middle').setFontItalic(true).setFontSize(12).fill('white');
